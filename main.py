...
if __name__ == '__main__':
  ...
  <footer class="footer">
    <p>&copy; 2024 All Rights Reserved By Krish Era.</p>
    <div class="dropdown">
      ...
      <ul class="dropdown-menu" aria-labelledby="contactDropdown">
        <li><a class="dropdown-item" href="https://www.facebook.com/profile.php?id=61553011640137">Facebook</a></li>
        <li><a class="dropdown-item" href="https://www.instagram.com/stonix.owak?igsh=c2tseG4waGp5aXJh==">Instagram</a></li>
      </ul>
    </div>
  </footer>
